package com.revature.datetypepesandstring;
...
public class Driver {
	...
	public void demo() {
		...
		l = 500000000000000l; // L allows for values greater than 31 bit
		...
		System.out.println(System.identityHashCode(sb)); // same memory location 
		sb.append("s");
		System.out.println(System.identityHashCode(sb));// same memory location 
...
//------------------------------------------------------------------------------------------------------------------------ 
		...
		System.out.println("Looping " +iterations + " time" );
		long curTime;
		String str="";
		...
		System.out.println("Start " + (System.currentTimeMillis() - curTime));
